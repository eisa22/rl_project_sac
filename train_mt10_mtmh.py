...
Based on the MT3 implementation (MTMH-SAC with ARS + Resets + Parallel Envs).
"""
...
def main():
    ...
    parser.add_argument("--pick_place_base_scale", type=float, default=100.0,
    ...
    parser.add_argument("--ars_max_scale", type=float, default=250.0,
    ...
    print(f"  num_envs_per_task = {num_envs_per_task}\n")
    ...
    if 'pick-place-v3' in TASK_NAMES:
        ...
        while step < args.total_steps:
            ...
            for idx, (task_id, env_idx) in enumerate(env_indices):
                    ...
                    if valid_means:
                        ...
                        for tid, m in enumerate(means):
                            if m is None or abs(m) < eps:
                                ...
                                if TASK_NAMES[tid] == 'pick-place-v3':
                ...
                if step > 0 and step % args.log_freq == 0:
                    ...
                    all_successes = [s for succ in task_episode_successes for s in succ[-100:]]
                    if all_successes:
                        wandb.log({
