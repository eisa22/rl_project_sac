#!/bin/bash
# MTMH-SAC MT10 Training on DataLAB Cluster
...
echo ""
echo "Tasks: reach, push, pick-place, door-open, drawer-close,"
echo "       button-press, peg-insert, window-open, drawer-open, door-close"
echo ""
...
echo "Command: python train_mt10_mtmh.py --seed $SEED"
echo ""
...
apptainer exec --nv \
    ...
    bash -c "
        ...
        python train_mt10_mtmh.py \
            --run_name mt10_mtmh_gpu_optimized_seed${SEED} \
...
echo "Log file: ${PROJECT_DIR}/logs/mt10_mtmh_${SLURM_JOB_ID}.log"
